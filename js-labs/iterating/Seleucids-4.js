...
function rulersForFivePlus(data) {
  var output = data.rulers.filter(function(item) {
...
function rulersNoConsorts(data) {
  ...
  var result = rulersNoConsorts(dataset);
  // console.log(result);
